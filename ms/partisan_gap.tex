...
In the pooled equation, which includes all questions we also include question fixed effects, \(\text{question}_j\).

The results from \cref{table:study4_results} show that

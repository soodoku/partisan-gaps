...
In total this yields five conditions, four multiple choice versions and one Likert scale, that successively remove inflationary survey design features, as shown in Table \ref{tab:conditions}. Each condition is explained in detail below:

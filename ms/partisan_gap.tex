...
There are two broad ways partisan gaps in political knowledge can come into existence. It could be that partisan gaps are a result of the fact that partisans know different things -- be it knowledge or misinformation. Or partisans gaps could be an artifact of the survey and questionnaire design.

\subsection*{Partisan Gaps in Knowledge}
On the other hand, partisan gaps in survey measures of political knowledge may reflect \emph{actual gaps} in the political knowledge of partisans. These gaps in political knowledge could be due do three factors. First, partisans know different correct things about politics. Second, partisan know different incorrect things. And lastly, partisans might be ignorant about different aspects of politics. These knowledge differentials might stem from different filter bubbles (\emph{CITES}), echo chambers (\emph{CITES}) or because partisans pay attention to different issues, topics, and politicians (\emph{CITES}). In this last way partisan gaps in political knowledge are similar to other types of gaps.\footnote{See research on the conditionality of gender \citep{dolan2011women, barabas2014question} or racial \citep{abrajano2015reexamining} gaps in political knowledge.} All these options are form of selective exposure, in this case differences in knowledge between partisans emerge because they know different (correct or incorrect) things about the world. Selective exposure (even conditional on no biases in memory, etc.) can lead partisans to know different correct and incorrect things about the world.
...
Partisan gaps in survey responses may also emerge as an \emph{artefact of questionnaire design}. Following this argument, knowledge gaps emerge because questionnairs are designed in a way that they encourage respondents to provide answers that are congenial with their ideological or partisan predispositions.
...
\Cref{fig:partisangaps-mturk} shows the results. Each marker represents how much more congenial the responses of the Republicans are to the Democrats.

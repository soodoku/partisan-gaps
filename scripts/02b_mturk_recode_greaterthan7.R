...
mturk$birth <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_birth, X24k_birth_7)))))
...
mturk$religion <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_religion, X24k_religion_7)))))
...
mturk$illegal <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_illegal, X24k_illegal_7)))))
...
mturk$death <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_death, X24k_death_7)))))
...
mturk$increase <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_increase, X24k_increase_7)))))
...
mturk$science <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_science, X24k_science_7)))))
...
mturk$deficit <- with(mturk, 
                    ...
                    ifelse(question_type == "14k", gs14k_deficit, X24k_deficit_7)))))

mturk$avg <- with(mturk, rowMeans(cbind(birth, religion, illegal, death, increase, science, mmr), na.rm = T))

write.csv(mturk, '../data/turk/mturk-recoded-greaterthan7.csv')
